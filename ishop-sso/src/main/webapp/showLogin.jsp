...
<form id="formlogin" method="post" onsubmit="return false;">
    <div class="easyui-dialog" title="管理员登录" data-options="closable:false,draggable:false" style="width:400px;height:300px;padding:10px;">
       	<div style="margin-left: 50px;margin-top: 50px;">
	        ...
	        <div>
	            <a id="login" option class="easyui-linkbutton" iconCls="icon-ok" style="width:100px;height:32px;margin-left: 50px">登录</a>
	            <a id="cancel" class="easyui-linkbutton" iconCls="icon-cancel" style="width:100px;height:32px;margin-left: 50px">取消</a>
	        </div>
       	</div>
    </div>
    </form>
